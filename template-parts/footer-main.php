        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p class="copyright"><?php _e( '&copy; Copyright', 'appetizer-light' ); ?> <?php echo date_i18n( __( 'Y', 'appetizer-light' ) ); ?> <?php bloginfo('name'); ?>. <?php _e('All Rights Reserved', 'appetizer-light' ); ?>.</p>
                    <p class="credits"><?php _e( 'WordPress Theme by', 'appetizer-light' ); ?> <a href="https://www.alian.it" class="credits-link" target="_blank">Alian Schiavoncini</a></p>
                </div>
            </div>          
        </div>
    </section> <!-- /footer-main -->
